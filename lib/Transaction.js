!function(){
    ...
    module.exports = function(database) {
        ...
        Object.keys(database._models).forEach(function(modelName) {
            var Model = transactionInstanceDeifinition[modelName] = function() {
                if (Model instanceof this) {
                    return database[modelName].prototype.constructor.apply(this, [instance].concat(Array.prototype.splice.call(arguments)));
                }
                else {
