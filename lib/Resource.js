!function () {
    ...
    module.exports = new Class({
        ...
        , prepare: function(dontSelect) {
            ...
            if (!dontSelect) this._selectChildren(this);
        }
        ...
        , applyJoins: function(targetResource, leftJoin) {
            ...
            if (this._filterDeleted && this.getDefinition().deletedTimestamp) {
                if (!this.getRootResoure().query.filter[name]) this.getRootResoure().query.filter[name] = {};
                this.getRootResoure().query.filter[name][this.getDefinition().deletedTimestamp] = null;
            }
