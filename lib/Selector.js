(function() {
    ...
    module.exports = new Class({
        ...
        , registerExtension: function(extension) {
            ...
            if (this.classDefinition.extensions[name]) return;//throw new Error('Cannot register «'+name+'» extension, an extension with the same name was already registered before!');
