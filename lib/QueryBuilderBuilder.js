(function() {
    ...
    module.exports = new Class({
        ...
        init: function(options){
            ...
            this.accessorMap        = {get:{}, fetch: {}, join: {}, leftJoin: {}};
            this.description        = {};
        ...
        , addMappingMethods: function(classDefinition) {
            Object.keys(this.columns).filter(function(id){
                ...
                var   target        = this.columns[id].definition
                    ...
                    , leftJoinName  = this.getAccessorName(id, 3);
                ...
                this.accessorMap.leftJoin[id] = function(returnTarget) {
                    return this._handleMapping(column, target, null, returnTarget, true, true);
                };
                ...
                this.description[leftJoinName]  = 'Mapping accessor for the «'+id+'» Model';
                ...
                classDefinition[leftJoinName]   = Class(this.accessorMap.leftJoin[id]).Enumerable();
            }.bind(this));
        }
        ...
        , addBelongsToMethods: function(classDefinition) {
            Object.keys(this.columns).filter(function(id){
                ...
                this.accessorMap.leftJoin[id] = function(returnTarget) {
                    return this._handleBelongsTo(column, target, null, returnTarget, true, true);
                };
                ...
                if (target.aliasName) {
                    ...
                    this.accessorMap.leftJoin[target.aliasName] = this.accessorMap.leftJoin[id];
                }
                ...
                this.description[leftJoinName]  = 'Belongs to accessor for the «'+id+'» Model';
        ...
        , addReferenceMethods: function(classDefinition) {
            Object.keys(this.columns).filter(function(id){
                ...
                this.accessorMap.leftJoin[id] = function(returnTarget) {
                    return this._handleReference(column, target, null, returnTarget, true, true);
                };
                ...
                if (column.aliasName) {
                    ...
                    this.accessorMap.leftJoin[column.aliasName] = this.accessorMap.leftJoin[id];
                }
                ...
                this.description[leftJoinName]  = 'Reference accessor for the «'+id+'» Model';
        ...
        , addGenericMethods: function(classDefinition) {
            ...
            classDefinition.leftJoin = Class(function(targetName, returnTarget) {
                if (Object.hasOwnProperty.call(accessorMap.leftJoin, targetName)) {
                    return accessorMap.leftJoin[targetName].apply(this, Array.prototype.slice.call(arguments, 1), !!returnTarget);
                } else throw new Error('The QueryBuilder has no property «'+targetName+'»!');
            }).Enumerable();



            // generic method for checking if a given entity exists
            classDefinition.has = Class(function(targetName) {
                return Object.hasOwnProperty.call(accessorMap.get, targetName);
            }).Enumerable();
        ...
        , getAccessorName: function(id, method) {
            ...
            else if (method === 3) return 'leftJoin' + id[0].toUpperCase()+id.slice(1);
