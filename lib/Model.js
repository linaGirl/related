        ...
        , _delete: function(transaction, callback) {
            ...
            if (this._fromDb){
                ...
                if (!Object.keys(query.filter).length) {
                    ...
                    this._emitEvent('beforeDelete', function(err) {
                        if (err) callback(err);
                        else this._emitEvent('afterDelete', callback, transaction, callback);
                    }.bind(this), transaction, function() {
