    ...
    module.exports = new Class({
        ...
        */
        , save: function(...args) {
            ...
            let callback, transaction, stack;
            ...
            // invoke the saving process
            const promise = this._prepareSave({dontReload, transaction, args, stack});
        ...
        */
        , _prepareSave: function({dontReload, transaction, args, stack}) {
            ...
            return this._enqueue().then((executeNext) => {
                ...
                if (transaction || this._getDatabase().isTransaction()) {
                    ...
                    // make sure the next callback is invoked!
                    return this._save({transaction, dontReload, stack}).then(() => {
         ...
         */
        , _save: function({transaction, dontReload, stack}) {
