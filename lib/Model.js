(function() {
    ...
    module.exports = new Class({
        ...
        , init: function(options) {
            ...
            Class.define(this, '_events'            , Class(options.events));
        ...
        */
        , _emitEvent: function(event, ...args) {
            ...
            let listeners = this._extensionEventListeners[event] ? this._extensionEventListeners[event].concat(this.listener(event)) : this.listener(event);
            

            // entity events
            if (this._events && this._events.has(event)) {
                listeners = listeners.concat(this._events.get(event));
            }
