!function(){
    ...
    module.exports = new Class({
        ...
        /**
         * can be sued when cloning to tell 
         */
        , including: function(entities) {

        }



        , excluding: function(entities) {
        ...
        , _addQueryObject: function(propertyName, item) {
            ...
            else if (type.object(item) && !type.null(item) && ((item.isModel && item.isModel()) || item.isQuery)) {
                // we got a model
