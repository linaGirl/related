(function() {
    ...
    module.exports = new Class({
                                    ...
                                    if (map[record.____id____]) {
                                        map[record.____id____].forEach((parentRecord) => {
                                            ...
                                            if (childResource.type === 'mapping' || childResource.type === 'belongsTo') {
                                                if (!parentRecord[childResource.loaderId]) parentRecord[childResource.loaderId] = [];
                                                parentRecord[childResource.loaderId].push(record);
                                            }
                                            else {
                                                // reference
        ...
        , _makeSet: function(rows, resource) {
            ...
            if (resource.getRootResoure().raw) return rows;
            else {
                let records = new Set({
