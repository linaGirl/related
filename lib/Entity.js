(function() {
    ...
    let QueryBuilderBuilder   = require('./QueryBuilderBuilder');
    ...
    module.exports = new Class({
        ...
        init: function(_options){
            ...
            let Constructor = function(scope, options, relatingSets) { 
                var isScoped = false;              
        ...
        , createQueryBuilder: function() {
            ...
            this._queryBuilders[this._definition.getName()] = this.QueryBuilder;
        }
