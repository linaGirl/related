(function() {
    ...
    module.exports = new Class({
        ...
        init: function(_options){
            ...
            // the user may register events on models
            ...
            // entity events
            Constructor.on = this.addModelListener.bind(this);
            Constructor.off = this.removeModelListener.bind(this);

            Constructor.reload = this.reload.bind(this);
        ...
        /**
        * the user may install model wide event listeners
        */
        , addModelListener: function(eventName, listener){
        ...
        /**
        * the user may remove model events again
        */
        , removeModelListener: function(eventName, listener) {
            if (eventName) {
                if (this._events.has(eventName)) {
                    ...
                    } else this._events.set(eventName, []);
                }
